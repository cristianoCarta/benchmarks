...
t1,t2,t3,t4 = benchmark.benchmark_row_wise("outputs/f2/row_wise/core/f2",N,iterations,6,hdf5_driver="core",plot=True,save=True)
t1,t2,t3,t4 = benchmark.benchmark_row_wise("outputs/f2/row_wise/sec2/f2",N,iterations,6,hdf5_driver="sec2",plot=True,save=True)
...
t1,t2,t3,t4 = benchmark.benchmark_bounding_boxes_conversion("outputs/f2/bounding_boxes/core/f2",N,iterations,6,hdf5_driver="core",plot=True,save=True)
t1,t2,t3,t4 = benchmark.benchmark_bounding_boxes_conversion("outputs/f2/bounding_boxes/sec2/f2",N,iterations,6,hdf5_driver="sec2",plot=True,save=True)
